...
const product= data.filter(item => item.category === "Electronics")
console.log(product);

console.log(product.map(names => names.name.toUpperCase()));

console.log(product.reduce((acc , curr) => acc + curr.price , 0));

console.log(data.filter(product => product.price > 500));
